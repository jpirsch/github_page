...
//    vec3 dir = camera( uv ) * rotX( mickey.y+.15)*rotY(mickey.x-.12);
    vec3 pos = vec3( .2, .5, -1.5 ) * rotX( 0. ) * rotY( 0. );
...
# endif
        ...
        col = texture2D(texture, dir.xy).rgb * vec3(.2, .3, .5);
...
/*const NoisesUni = [[name:'texture', type:'t', url:img]
                    [name:'value', type:'f']]
export NoisesUni;*/
